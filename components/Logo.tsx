...
export function Logo({ className, ...props }: LogoProps) {
  return (
    <svg
      ...
      aria-hidden="true"
      className={cn("fill-[#B0B0B0] stroke-[#B0B0B0] dark:fill-[#ffffff] dark:stroke-[#ffffff]", className)}
      style={{ transform: "rotate(1.42747deg)", ...props.style }}
      {...props}
    >
      <path
        ...
        fill="#FF7D0C"
        style={{
          transform: "translateY(0.0363196px) scaleX(0.999855)",
      ...
      <path
        ...
        fill="#FE9332"
        style={{
          transform: "translateY(1.73751px) scaleX(1.01158)",
          transformOrigin: "50% 50%",
          transformBox: "fill-box",
        }}
      />
